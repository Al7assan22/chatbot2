...
def ask_gemini_chatbot(user_input):
    ...
    dev_questions = [
        ...
        "مين الي صممك", "مين صممك", "مين الا طورك", "مين الا صممك", "من صنعك","مين الا صنعك","مين الا طورك","مين الا عملك","مين الا شغلك","مين اللى طورك", "مين اللى صممك","مين اللى صنعك","مين اللى طورك","مين اللى عملك","مين اللى شغلك"
    ]
