...
def ask_gemini_chatbot(user_input):
    ...
    dev_questions = [
        ...
        "مين اللي صممك", "مين صممك", "مين الا طورك", "مين الا صممك", "من صنعك","مين الا صنعك","مين الا طورك","مين الا عملك","مين الا شغلك","مين اللى طورك", "مين اللى صممك","مين اللى صنعك","مين اللي طورك", "مين اللي صممك","مين اللي صنعك","مين اللي طورك","مين اللي عملك","مين اللي شغلك","مين الي صممك","مين الى صممك","مين الي عملك","مين الى عملك","مين اللي صممك يسطا","مين اللى طورك","مين اللى عملك","مين اللى شغلك","مين اللي صمم"]
